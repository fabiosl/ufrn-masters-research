...
% , but this transition can be recommended depending on the scenario

% > Migrations should not only test performance, but semantic results, as any other refactoring.
