...
\titulo{\Large{TODO::CHANGE::Guidelines for database transitioning on production environments}}
...
\comentario
{
	Proposta de dissertação de Mestrado  apresentada ao Programa de Pós-Graduação em Sistemas e Computação do Departamento de Informática e Matemática Aplicada da Universidade Federal do Rio Grande do Norte como requisito parcial para a obtenção do grau de Mestre em Sistemas e Computação.\bigskip\\
